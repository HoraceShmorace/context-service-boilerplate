var jsdom = require('jsdom'),
	...
	_matchKeywords = function(compiledKeywords,url,parsedHtmlDataPoints,urlWeight,next){
		...
		for(var p=0,len=parsedHtmlDataPoints.length;p<len;p++){
			...
			var value = dataPoint.filter? dataPoint.filter(dataPoint.value) : dataPoint.value;
			var matches = value.match(['url','link|canonical'].indexOf(dataPoint.name)!=-1 ? urlKeywordRegex:keywordRegex);
